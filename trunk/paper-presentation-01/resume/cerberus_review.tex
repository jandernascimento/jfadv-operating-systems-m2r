...
\begin{itemize}
  ...
  \item Efficient Resource Sharing.
   ...
   operating systems.
	...
	Fortunately most of multi-threaded application required only exclusive access to those resources, but for those where this is a requirement a hybrid approach is used. So by combining local and remote file access is possible to reduce the contention while maintain an acceptable performance file sharing. %what is acceptable performance file sharing???
